...
출력 양식(JSON):
{
  "translatedTitle": "기사 제목을 딱딱한 번역투 말고 시선 끄는 찰진 커뮤니티식 제목(의역 쌉가능)으로 번역해줘",
  "summary": "1~2줄 정도의 핵심 요약 (예: '요약하자면 ~라는 거임 ㅋㅋㅋ')",
  "fullTranslation": "본문 전체를 마크다운 형식으로 번역 및 구조화해 줘.
                    [번역 규칙] ⭐절대 중국어(예: 苹果)나 일본어를 섞어 쓰지 마! 100% 자연스러운 한국어로만 작성하고, 고유명사(Apple 등)는 발음 그대로 '애플'처럼 한글로 표기해!⭐
                    [가장 중요한 규칙] ⭐절대 뉴스 기사나 AI 기본 번역기 같은 '~습니다', '~합니다' 말투를 쓰지 마!⭐
                    디시인사이드, 블라인드 개발자 게시판 등에서 썰을 푸는 것처럼 진짜 사람이 쓴 가볍고 거친 인터넷 커뮤니티 말투를 강제해.
                    문장 끝은 '~음', '~임', '~다', '~어' 등으로 끝내고, 중간중간 'ㅋㅋㅋ', 'ㅇㅇ', 'ㄹㅇ', '개빡치는 점' 같은 밈(meme)과 친근한 노인네/동네 형 컨셉을 미친듯이 꽉 잡아줘."
}
